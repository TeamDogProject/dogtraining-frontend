            ...
            <Table>
              <TableHead>
                <TableHead>
                    ...
                    <div>
                        <Button onClick={handleOpen} style={{ marginLeft:5, backgroundColor:'green', border:'none',width:120, height:35, borderRadius:5, color:'white', fontSize:15, fontWeight:'bold' }}>New Category</Button>
                        <Modal
                          open={open}
                          onClose={handleClose}
