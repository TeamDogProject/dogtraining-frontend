      ...
      <Container maxWidth="xl">
        <Grid container spacing={2} justifyContent="center">
          <Grid item xs={12} md={6} lg={4}>
            <Box sx={{width: '100%', maxWidth: '900px', height: '100%', paddingTop: 5, paddingBottom:5}}>
              <Typography
                component="div"
                variant="h2"
              ...
              <Typography
                ...
                variant="body1"
                width={'100%'}
                sx={{width: '100%', maxWidth: '900px', fontFamily: 'roboto', color: 'inherit',textAlign: 'justify' }}
              >
                <p>Dog Training es una plataforma de entrenamiento para perros, queremos convertirnos
                ...
                <br />
                <p>Nuestro proyecto nace por el incremento de mascotas en los
